...
export default function NewModal(props: Props) {
  ...
  return (
    <div className="fixed z-10 top-0 left-0 w-screen text-white h-screen flex items-center justify-center ">
      <div
        onClick={() => {
      ...
      ></div>
      <div className="w-[720px] flex z-30 h-[600px] bg-neutral-900 rounded-[20px] overflow-hidden">
        <div className="border-r border-white/20 h-full w-1/2">
          <div className="h-[80px] p-5 pb-4 text-[24px] font-bold flex items-end border-b border-white/20">
            Settings
          </div>
            ...
            {settings.map((element, index) => {
              return (
                <div
                  ...
                  className="p-2 px-5 border-b border-white/20"
                >
                  {element}
                </div>
              )
        ...
        <div className="h-full w-1/2">
          <div className="h-[80px] p-5 pb-4 justify-between flex items-end border-b border-white/20">
  ...
  return (
    <div className="flex flex-col gap-[20px] ">
      ...
      <div className="w-full">
        <div className="font-light mb-[6px] text-white/50 px-4 text-[14px]">
          NAME
        </div>
        <input
          type="text"
